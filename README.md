...
## アプリ画面<br>
![カンバンボード](images/image_kanban.png)
...
## 制作背景<br>
訪問看護師として勤務する中で、カルテチェック業務の管理係を担当していました。<br>  
...
## 解決策<br> 
### ＊直感的な進捗把握<br>
カンバンボードにより、誰が・どのタスクを・どの段階まで進めているかが一目で分かります。  

### ＊期限の可視化<br> 
期限が迫っているタスクが強調されることで、管理者の「探し出す」手間を省きます。  

### ＊「スキマ時間」の有効活用<br>
5分・10分といった短時間で終わるタスクを抽出。忙しい訪問の合間でも、スタッフが自発的にタスクを消化できる仕組みを作りました。  